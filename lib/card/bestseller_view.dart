...
class BestSellerListView extends StatefulWidget {
  ...
  BestSellerListView(this.isVertical);
  @override
  State<StatefulWidget> createState() {
    return BestSellerListViewState();
  }
}

class BestSellerListViewState extends State<BestSellerListView> {
      ...
      productCard = Container(
        ...
        child: ListView.builder(
          itemBuilder: (BuildContext context, int index) =>
              _buildBestSellerItems(context, index, products.where((a) => a.isBestSeller == true).toList()[index], model),
          scrollDirection: Axis.horizontal,
          itemCount: products.where((a) => a.isBestSeller == true).length,
        ),
      );
    } else {
    ...
    if (products.length > 0) {
      productCard = Container(
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) => _buildBestSellerItems(
            context,
            index,
            products.where((a) => a.isBestSeller == true).toList()[index],
            model,
          ),

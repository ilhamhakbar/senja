...
//------------------------------------------TEXTSTYLE
TextStyle h1 =
    TextStyle(fontSize: sizeHorizontal * 8.5, fontWeight: FontWeight.bold);

TextStyle h2 = TextStyle(fontSize: sizeHorizontal * 7, fontFamily: "SFBold");

TextStyle h3 =
    TextStyle(fontSize: sizeHorizontal * 6, fontWeight: FontWeight.bold);

TextStyle h4 =
    TextStyle(fontSize: sizeHorizontal * 5, fontWeight: FontWeight.bold);

TextStyle h5 =
    TextStyle(fontSize: sizeHorizontal * 4, fontWeight: FontWeight.bold);

TextStyle t1 = TextStyle(
  fontSize: sizeHorizontal * 8.5,
);

TextStyle t2 = TextStyle(fontSize: sizeHorizontal * 6, fontFamily: "SFRegular");

TextStyle t3 = TextStyle(fontSize: sizeHorizontal * 5.5, fontFamily: "SFRegular");
